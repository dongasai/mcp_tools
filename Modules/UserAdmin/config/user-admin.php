...
return [
    ...
    */
    ...
    |
    */
    'directory' => base_path('Modules/UserAdmin'),
   ...
   */
    ...
    */
    'auth' => [
        ...
        'controller' => Modules\UserAdmin\Http\Controllers\UserAdmin\AuthController::class,
    ...
    */
    'database' => [
        ...
        'users_table' => 'users',
        'users_model' => Modules\User\Models\User::class,

        // Role table and model.
        'roles_table' => 'user_admin_roles',
        'roles_model' => Modules\UserAdmin\Entities\UserAdminRole::class,

        // Permission table and model.
        'permissions_table' => 'user_admin_permissions',
        'permissions_model' => Modules\UserAdmin\Entities\UserAdminPermission::class,

        // Menu table and model.
        'menu_table' => 'user_admin_menu',
        'menu_model' => Modules\UserAdmin\Entities\UserAdminMenu::class,
