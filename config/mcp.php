    ...
    */
    'discovery' => [
        ...
        'directories' => array_filter(
            explode(',',
                env('MCP_DISCOVERY_DIRECTORIES', 'Modules/MCP/Tools,Modules/MCP/Resources,Modules/Dbcont/Tools,Modules/Dbcont/Resources,Modules/Task/Tools,Modules/Task/Resources')
            )
        ),
        'exclude_dirs' => [
            'vendor',
