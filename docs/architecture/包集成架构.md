...
return [
    ...
    'resources' => [
        'task' => Modules\MCP\Resources\TaskResource::class,
        'project' => Modules\MCP\Resources\ProjectResource::class,
        'github' => Modules\MCP\Resources\GitHubResource::class,
    ],
    
    'tools' => [
        'task_management' => Modules\MCP\Tools\TaskManagementTool::class,
        'project_query' => Modules\MCP\Tools\ProjectQueryTool::class,
        'github_sync' => Modules\MCP\Tools\GitHubSyncTool::class,
    ],
];
```
