...
class AgentService
{
    ...
    public function create(User $user, array $data): Agent
    {
        ...
        // 分发事件
        $this->eventDispatcher->dispatch(new \App\Modules\Agent\Events\AgentCreated($agent));
    ...
    public function update(Agent $agent, array $data): Agent
    {
        ...
        if (isset($validatedData['status']) && $originalStatus !== $validatedData['status']) {
            ...
            $this->eventDispatcher->dispatch(new \App\Modules\Agent\Events\AgentStatusChanged($agent, $originalStatus));
        }
    ...
    public function activate(Agent $agent): Agent
    {
        ...
        // 分发事件
        $this->eventDispatcher->dispatch(new \App\Modules\Agent\Events\AgentActivated($agent));
    ...
    public function deactivate(Agent $agent): Agent
    {
        ...
        // 分发事件
        $this->eventDispatcher->dispatch(new \App\Modules\Agent\Events\AgentDeactivated($agent));
